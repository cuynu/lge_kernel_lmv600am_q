...
#define MAX_UNIFIED_NODES_SIZE	27
	...
	struct device* dev, struct device_attribute* attr, const char* buf, size_t size)
{
	...
	if (dev && dev->platform_data) {
		...
		switch (id) {
			case 2: ori = &ref->actm.max_hold_criteria_wired[0]; break;
			case 3: ori = &ref->actm.max_hold_criteria_wired[1]; break;
			case 4: ori = &ref->actm.max_hold_criteria_wired[2]; break;
			case 5: ori = &ref->actm.max_hold_criteria_wireless[0]; break;
			case 6: ori = &ref->actm.max_hold_criteria_wireless[1]; break;
			case 7: ori = &ref->actm.max_hold_criteria_wireless[2]; break;
		}
	...
	struct device* dev, struct device_attribute* attr, char* buf)
{
	...
	if (dev && dev->platform_data) {
		ref = (struct unified_nodes*)dev->platform_data;
		switch (id) {
			case 2: ret = ref->actm.max_hold_criteria_wired[0]; break;
			case 3: ret = ref->actm.max_hold_criteria_wired[1]; break;
			case 4: ret = ref->actm.max_hold_criteria_wired[2]; break;
			case 5: ret = ref->actm.max_hold_criteria_wireless[0]; break;
			case 6: ret = ref->actm.max_hold_criteria_wireless[1]; break;
			case 7: ret = ref->actm.max_hold_criteria_wireless[2]; break;
		}
	}
	...
	struct device* dev, struct device_attribute* attr, const char* buf, size_t size)
{
	...
	if (dev && dev->platform_data) {
		...
		switch (id) {
			case 8: ori = &ref->actm.tempoffs_wired[0]; break;
			case 9: ori = &ref->actm.tempoffs_wired[1]; break;
			case 10: ori = &ref->actm.tempoffs_wired[2]; break;
			case 11: ori = &ref->actm.tempoffs_wireless[0]; break;
			case 12: ori = &ref->actm.tempoffs_wireless[1]; break;
			case 13: ori = &ref->actm.tempoffs_wireless[2]; break;
		}
	...
	struct device* dev, struct device_attribute* attr, char* buf)
{
	...
	if (dev && dev->platform_data) {
		ref = (struct unified_nodes*)dev->platform_data;
		switch (id) {
			case 8: ret = ref->actm.tempoffs_wired[0]; break;
			case 9: ret = ref->actm.tempoffs_wired[1]; break;
			case 10: ret = ref->actm.tempoffs_wired[2]; break;
			case 11: ret = ref->actm.tempoffs_wireless[0]; break;
			case 12: ret = ref->actm.tempoffs_wireless[1]; break;
			case 13: ret = ref->actm.tempoffs_wireless[2]; break;
		}
	}
	...
	struct device* dev, struct device_attribute* attr, const char* buf, size_t size)
{
	...
	if (dev && dev->platform_data) {
		...
		switch (id) {
			case 14: ori = &ref->actm.current_wired[0]; break;
			case 15: ori = &ref->actm.current_wired[1]; break;
			case 16: ori = &ref->actm.current_wired[2]; break;
			case 17: ori = &ref->actm.power_epp[0]; break;
			case 18: ori = &ref->actm.power_epp[1]; break;
			case 19: ori = &ref->actm.power_epp[2]; break;
			case 20: ori = &ref->actm.power_bpp[0]; break;
			case 21: ori = &ref->actm.power_bpp[1]; break;
			case 22: ori = &ref->actm.power_bpp[2]; break;
			case 23: ori = &ref->actm.current_cp[0]; break;
			case 24: ori = &ref->actm.current_cp[1]; break;
		}
	...
	struct device* dev, struct device_attribute* attr, char* buf)
{
	...
	if (dev && dev->platform_data) {
		ref = (struct unified_nodes*)dev->platform_data;
		switch (id) {
			case 14: ret = ref->actm.current_wired[0]; break;
			case 15: ret = ref->actm.current_wired[1]; break;
			case 16: ret = ref->actm.current_wired[2]; break;
			case 17: ret = ref->actm.power_epp[0]; break;
			case 18: ret = ref->actm.power_epp[1]; break;
			case 19: ret = ref->actm.power_epp[2]; break;

			case 20: ret = ref->actm.power_bpp[0]; break;
			case 21: ret = ref->actm.power_bpp[1]; break;
			case 22: ret = ref->actm.power_bpp[2]; break;
			case 23: ret = ref->actm.current_cp[0]; break;
			case 24: ret = ref->actm.current_cp[1]; break;
		}
	}
	...
	struct device* dev, struct device_attribute* attr, const char* buf, size_t size)
{
	...
	if (dev && dev->platform_data) {
		...
		switch (id) {
			case 25: ori = &ref->actm.sensor_type[0]; break;
			case 26: ori = &ref->actm.sensor_type[1]; break;
		}
	...
	struct device* dev, struct device_attribute* attr, char* buf)
{
	...
	if (dev && dev->platform_data) {
		ref = (struct unified_nodes*)dev->platform_data;
		switch (id) {
			case 25: ret = ref->actm.sensor_type[0]; break;
			case 26: ret = ref->actm.sensor_type[1]; break;
		}
	}
...
/*  2 */__ATTR(actm_holddeg_wired_0,     0664, actm_holddeg_show,  actm_holddeg_store ),
/*  3 */__ATTR(actm_holddeg_wired_1,     0664, actm_holddeg_show,  actm_holddeg_store ),
/*  4 */__ATTR(actm_holddeg_wired_2,     0664, actm_holddeg_show,  actm_holddeg_store ),
/*  5 */__ATTR(actm_holddeg_wireless_0,  0664, actm_holddeg_show,  actm_holddeg_store ),
/*  6 */__ATTR(actm_holddeg_wireless_1,  0664, actm_holddeg_show,  actm_holddeg_store ),
/*  7 */__ATTR(actm_holddeg_wireless_2,  0664, actm_holddeg_show,  actm_holddeg_store ),

/*  8 */__ATTR(actm_tempoffs_wired_0,    0664, actm_tempoffs_show, actm_tempoffs_store),
/*  9 */__ATTR(actm_tempoffs_wired_1,    0664, actm_tempoffs_show, actm_tempoffs_store),
/* 10 */__ATTR(actm_tempoffs_wired_2,    0664, actm_tempoffs_show, actm_tempoffs_store),
/* 11 */__ATTR(actm_tempoffs_wireless_0, 0664, actm_tempoffs_show, actm_tempoffs_store),
/* 12 */__ATTR(actm_tempoffs_wireless_1, 0664, actm_tempoffs_show, actm_tempoffs_store),
/* 13 */__ATTR(actm_tempoffs_wireless_2, 0664, actm_tempoffs_show, actm_tempoffs_store),

/* 14 */__ATTR(actm_current_wired_0,     0664, actm_current_show,  actm_current_store ),
/* 15 */__ATTR(actm_current_wired_1,     0664, actm_current_show,  actm_current_store ),
/* 16 */__ATTR(actm_current_wired_2,     0664, actm_current_show,  actm_current_store ),
/* 17 */__ATTR(actm_power_epp_0,         0664, actm_current_show,  actm_current_store ),
/* 18 */__ATTR(actm_power_epp_1,         0664, actm_current_show,  actm_current_store ),
/* 19 */__ATTR(actm_power_epp_2,         0664, actm_current_show,  actm_current_store ),
/* 20 */__ATTR(actm_power_bpp_0,         0664, actm_current_show,  actm_current_store ),
/* 21 */__ATTR(actm_power_bpp_1,         0664, actm_current_show,  actm_current_store ),
/* 22 */__ATTR(actm_power_bpp_2,         0664, actm_current_show,  actm_current_store ),
/* 23 */__ATTR(actm_curr_cp_pps,         0664, actm_current_show,  actm_current_store ),
/* 24 */__ATTR(actm_curr_cp_qc30,        0664, actm_current_show,  actm_current_store ),

/* 25 */__ATTR(actm_sensor_wired,        0664, actm_sensor_show,   actm_sensor_store  ),
/* 26 */__ATTR(actm_sensor_wireless,     0664, actm_sensor_show,   actm_sensor_store  ),
/* 27 ==> must check "#define MAX_UNIFIED_NODES_SIZE 27" */
